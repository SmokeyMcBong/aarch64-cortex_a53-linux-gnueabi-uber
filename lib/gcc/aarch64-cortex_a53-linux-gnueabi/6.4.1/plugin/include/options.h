...
#endif
#ifdef GENERATOR_FILE
extern int nopcrelative_literal_loads;
#else
  int x_nopcrelative_literal_loads;
#define nopcrelative_literal_loads global_options.x_nopcrelative_literal_loads
#endif
#ifdef GENERATOR_FILE
...
struct GTY(()) cl_target_option
{
  ...
  signed char x_nopcrelative_literal_loads;
};
...
enum opt_code
{
  ...
  OPT_fuse_ld_mcld = 1107,                   /* -fuse-ld=mcld */
  OPT_fuse_linker_plugin = 1108,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1109,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1110,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1111,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1112,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1113,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1114, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1115,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1116,                   /* -fverbose-asm */
  /* OPT_fversion = 1117, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1118,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1119,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1120,                   /* -fvisibility= */
  OPT_fvpt = 1121,                           /* -fvpt */
  /* OPT_fvtable_gc = 1122, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1123, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1124,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1125,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1126,                     /* -fvtv-debug */
  OPT_fweak = 1127,                          /* -fweak */
  OPT_fweb = 1128,                           /* -fweb */
  /* OPT_fwhole_file = 1129, */              /* -fwhole-file */
  OPT_fwhole_program = 1130,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1131,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1132,             /* -fworking-directory */
  OPT_fwpa = 1133,                           /* -fwpa */
  OPT_fwpa_ = 1134,                          /* -fwpa= */
  OPT_fwrapv = 1135,                         /* -fwrapv */
  /* OPT_fxref = 1136, */                    /* -fxref */
  /* OPT_fzee = 1137, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1138,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1139,                     /* -fzero-link */
  OPT_g = 1140,                              /* -g */
  OPT_gant = 1141,                           /* -gant */
  OPT_gcoff = 1142,                          /* -gcoff */
  OPT_gdwarf = 1143,                         /* -gdwarf */
  OPT_gdwarf_ = 1144,                        /* -gdwarf- */
  OPT_gen_decls = 1145,                      /* -gen-decls */
  OPT_ggdb = 1146,                           /* -ggdb */
  OPT_ggnu_pubnames = 1147,                  /* -ggnu-pubnames */
  OPT_gnat = 1148,                           /* -gnat */
  OPT_gnatO = 1149,                          /* -gnatO */
  OPT_gno_pubnames = 1150,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1151,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1152,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1153,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1154,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1155,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1156,                   /* -gsplit-dwarf */
  OPT_gstabs = 1157,                         /* -gstabs */
  OPT_gstabs_ = 1158,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1159,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1160,                        /* -gtoggle */
  OPT_gvms = 1161,                           /* -gvms */
  OPT_gxcoff = 1162,                         /* -gxcoff */
  OPT_gxcoff_ = 1163,                        /* -gxcoff+ */
  OPT_gz = 1164,                             /* -gz */
  OPT_gz_ = 1165,                            /* -gz= */
  OPT_h = 1166,                              /* -h */
  OPT_idirafter = 1167,                      /* -idirafter */
  OPT_imacros = 1168,                        /* -imacros */
  OPT_imultiarch = 1169,                     /* -imultiarch */
  OPT_imultilib = 1170,                      /* -imultilib */
  OPT_include = 1171,                        /* -include */
  OPT_iplugindir_ = 1172,                    /* -iplugindir= */
  OPT_iprefix = 1173,                        /* -iprefix */
  OPT_iquote = 1174,                         /* -iquote */
  OPT_isysroot = 1175,                       /* -isysroot */
  OPT_isystem = 1176,                        /* -isystem */
  OPT_iwithprefix = 1177,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1178,              /* -iwithprefixbefore */
  OPT_k8 = 1179,                             /* -k8 */
  OPT_l = 1180,                              /* -l */
  OPT_lang_asm = 1181,                       /* -lang-asm */
  OPT_mabi_ = 1182,                          /* -mabi= */
  OPT_mandroid = 1183,                       /* -mandroid */
  OPT_march_ = 1184,                         /* -march= */
  OPT_mbig_endian = 1185,                    /* -mbig-endian */
  OPT_mbionic = 1186,                        /* -mbionic */
  OPT_mcmodel_ = 1187,                       /* -mcmodel= */
  OPT_mcpu_ = 1188,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1189,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1190,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1191,             /* -mgeneral-regs-only */
  OPT_mglibc = 1192,                         /* -mglibc */
  OPT_mlittle_endian = 1193,                 /* -mlittle-endian */
  OPT_mlow_precision_recip_sqrt = 1194,      /* -mlow-precision-recip-sqrt */
  ...
  OPT_n = 1204,                              /* -n */
  OPT_no_canonical_prefixes = 1205,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1206,              /* -no-integrated-cpp */
  OPT_no_pie = 1207,                         /* -no-pie */
  OPT_nocpp = 1208,                          /* -nocpp */
  OPT_nodefaultlibs = 1209,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1210,                   /* -nostartfiles */
  OPT_nostdinc = 1211,                       /* -nostdinc */
  OPT_nostdinc__ = 1212,                     /* -nostdinc++ */
  OPT_nostdlib = 1213,                       /* -nostdlib */
  OPT_o = 1214,                              /* -o */
  OPT_p = 1215,                              /* -p */
  OPT_pass_exit_codes = 1216,                /* -pass-exit-codes */
  /* OPT_pedantic = 1217, */                 /* -pedantic */
  OPT_pedantic_errors = 1218,                /* -pedantic-errors */
  OPT_pg = 1219,                             /* -pg */
  OPT_pie = 1220,                            /* -pie */
  OPT_pipe = 1221,                           /* -pipe */
  OPT_posix = 1222,                          /* -posix */
  OPT_print_file_name_ = 1223,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1224,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1225,          /* -print-multi-directory */
  OPT_print_multi_lib = 1226,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1227,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1228,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1229,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1230,               /* -print-prog-name= */
  OPT_print_search_dirs = 1231,              /* -print-search-dirs */
  OPT_print_sysroot = 1232,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1233,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1234,                        /* -profile */
  OPT_pthread = 1235,                        /* -pthread */
  OPT_quiet = 1236,                          /* -quiet */
  OPT_r = 1237,                              /* -r */
  OPT_rdynamic = 1238,                       /* -rdynamic */
  OPT_remap = 1239,                          /* -remap */
  OPT_s = 1240,                              /* -s */
  OPT_s_bc_abi = 1241,                       /* -s-bc-abi */
  OPT_save_temps = 1242,                     /* -save-temps */
  OPT_save_temps_ = 1243,                    /* -save-temps= */
  OPT_shared = 1244,                         /* -shared */
  OPT_shared_libgcc = 1245,                  /* -shared-libgcc */
  /* OPT_specs = 1246, */                    /* -specs */
  OPT_specs_ = 1247,                         /* -specs= */
  OPT_static = 1248,                         /* -static */
  OPT_static_libasan = 1249,                 /* -static-libasan */
  OPT_static_libgcc = 1250,                  /* -static-libgcc */
  OPT_static_libgcj = 1251,                  /* -static-libgcj */
  OPT_static_libgfortran = 1252,             /* -static-libgfortran */
  OPT_static_libgo = 1253,                   /* -static-libgo */
  OPT_static_liblsan = 1254,                 /* -static-liblsan */
  OPT_static_libmpx = 1255,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1256,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1257,               /* -static-libstdc++ */
  OPT_static_libtsan = 1258,                 /* -static-libtsan */
  OPT_static_libubsan = 1259,                /* -static-libubsan */
  /* OPT_std_c__03 = 1260, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1261, */                /* -std=c++0x */
  OPT_std_c__11 = 1262,                      /* -std=c++11 */
  OPT_std_c__14 = 1263,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1264, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1265, */                /* -std=c++1y */
  OPT_std_c__1z = 1266,                      /* -std=c++1z */
  OPT_std_c__98 = 1267,                      /* -std=c++98 */
  OPT_std_c11 = 1268,                        /* -std=c11 */
  /* OPT_std_c1x = 1269, */                  /* -std=c1x */
  /* OPT_std_c89 = 1270, */                  /* -std=c89 */
  OPT_std_c90 = 1271,                        /* -std=c90 */
  OPT_std_c99 = 1272,                        /* -std=c99 */
  /* OPT_std_c9x = 1273, */                  /* -std=c9x */
  OPT_std_f2003 = 1274,                      /* -std=f2003 */
  OPT_std_f2008 = 1275,                      /* -std=f2008 */
  OPT_std_f2008ts = 1276,                    /* -std=f2008ts */
  OPT_std_f95 = 1277,                        /* -std=f95 */
  OPT_std_gnu = 1278,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1279, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1280, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1281,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1282,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1283, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1284, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1285,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1286,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1287,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1288, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1289, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1290,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1291,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1292, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1293, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1294,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1295, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1296, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1297, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1298,                     /* -std=legacy */
  OPT_symbolic = 1299,                       /* -symbolic */
  OPT_t = 1300,                              /* -t */
  OPT_time = 1301,                           /* -time */
  OPT_time_ = 1302,                          /* -time= */
  OPT_tno_android_cc = 1303,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1304,                 /* -tno-android-ld */
  OPT_traditional = 1305,                    /* -traditional */
  OPT_traditional_cpp = 1306,                /* -traditional-cpp */
  OPT_trigraphs = 1307,                      /* -trigraphs */
  OPT_u = 1308,                              /* -u */
  OPT_undef = 1309,                          /* -undef */
  OPT_v = 1310,                              /* -v */
  OPT_version = 1311,                        /* -version */
  OPT_w = 1312,                              /* -w */
  OPT_wrapper = 1313,                        /* -wrapper */
  OPT_x = 1314,                              /* -x */
  OPT_z = 1315,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
