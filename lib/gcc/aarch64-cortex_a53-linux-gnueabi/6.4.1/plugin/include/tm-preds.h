/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/djb77/android/crosstool-ng/.build/aarch64-cortex_a53-linux-gnueabi/build/src/gcc/gcc/config/aarch64/aarch64.md'.  */
...
{
  if (c >= CONSTRAINT_Upl && c <= CONSTRAINT_Dd)
    return;
